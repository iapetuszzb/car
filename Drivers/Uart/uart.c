...
#define BT_ENCODER_DECODE_SCALE            (ENCODER_DECODE_MULTIPLIER)

#define BT_FORWARD_MIN_DISTANCE_M          (0.02f)
#define BT_FORWARD_MAX_DISTANCE_M          (10.0f)
#define BT_FORWARD_CRUISE_PULSES_TICK      (5.0f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_MIN_PULSES_TICK         (1.5f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_BRAKE_DISTANCE_MM       (250.0f)
#define BT_FORWARD_STOP_TOLERANCE_MM       (8.0f)
#define BT_FORWARD_ACCEL_PULSES_TICK2      (0.25f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_DECEL_PULSES_TICK2      (0.40f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_YAW_KP                  (0.12f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_YAW_KD_RATE             (0.008f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_YAW_CORR_LIMIT          (2.0f * BT_ENCODER_DECODE_SCALE)
#define BT_FORWARD_YAW_SIGN                (1.0f)

#define BT_TURN_MIN_ANGLE_DEG              (1.0f)
#define BT_TURN_MAX_ANGLE_DEG              (360.0f)
#define BT_TURN_YAW_KP                     (0.07f * BT_ENCODER_DECODE_SCALE)
#define BT_TURN_YAW_KD_RATE                (0.010f * BT_ENCODER_DECODE_SCALE)
#define BT_TURN_MOTOR_SIGN                 (1.0f)
#define BT_TURN_MAX_PULSES_TICK            (4.5f * BT_ENCODER_DECODE_SCALE)
#define BT_TURN_MIN_PULSES_TICK            (1.3f * BT_ENCODER_DECODE_SCALE)
#define BT_TURN_ACCEL_PULSES_TICK2         (0.25f * BT_ENCODER_DECODE_SCALE)
#define BT_TURN_DECEL_PULSES_TICK2         (0.45f * BT_ENCODER_DECODE_SCALE)
...
#define BT_SPEED_PI_KP                     (700.0f / BT_ENCODER_DECODE_SCALE)
#define BT_SPEED_PI_KI                     (80.0f / BT_ENCODER_DECODE_SCALE)
#define BT_SPEED_PI_INTEGRAL_LIMIT         (12000.0f)
#define BT_SPEED_MIN_PWM                   (10500.0f)
#define BT_SPEED_FF_PWM_PER_PULSE          (900.0f / BT_ENCODER_DECODE_SCALE)
